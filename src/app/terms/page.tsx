    ...
    <section className="py-12 md:py-16">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        <div className="prose prose-lg max-w-none dark:prose-invert">
          ...
          <p>
            <em>Last updated</em>: January 06, 2023
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              or &quot;Our&quot; in this Agreement) refers to AstroWind LLC, 1 Cupertino, CA 95014.
            </li>
            <li>
            ...
            <li>
              ...
              This Terms and Conditions agreement is a Demo.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to AstroWind, accessible from{' '}
              <a href="https://astrowind.vercel.app">https://astrowind.vercel.app</a>
            </li>
            <li>
